...
#### Tasks
1. Identify most prominent species within each dataset from MEGAN6 output
2. Download specific viral references of those viral species
3. Run all dataset sequences and viral references through BWA 
4. Analyse output through Geneious
